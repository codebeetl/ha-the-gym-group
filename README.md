...
| **Application version** | `7.8.1` | Sent as both `x-np-app-version` and the `applicationVersion=` segment of `x-np-user-agent`. |
| **Application version code** | `125` | The numeric build code, embedded in `x-np-user-agent`. |
